  ...
  return (
    <div className="contact-section outer1">
      <div className="first1">
        ...
        >
          {" "}
          <img className="logos" src={linkd} alt="" />{" "}
        ...
        <a
          ...
          rel="noreferrer"
          target="_blank"
          href={SocialLinks[0].emailID}
        >
          {" "}
          <img className="logos" src={email} alt="" />{" "}
          <span className="link-span"> Email</span>
        </a>
      </div>
      <div className="line"></div>
      <div className="second1">
        <div className="rights">
          © Copyright 2023 by {Name} All rights reserved{" "}
          <span className="footer-slash"> |</span>&nbsp;
          <a className="quatro" href="https://www.quatro.in/">
            {" "}
            Created by quatro <img
              className="quatro-link"
              src={quat}
              alt=""
            />{" "}
          </a>
